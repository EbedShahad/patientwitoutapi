...
//
//     final profilePatient = profilePatientFromJson(jsonString);

import 'dart:convert';

ProfilePatient profilePatientFromJson(String str) => ProfilePatient.fromJson(json.decode(str));

String profilePatientToJson(ProfilePatient data) => json.encode(data.toJson());
...
class ProfilePatient {
    ...
    factory ProfilePatient.fromJson(Map<String, dynamic> json) => ProfilePatient(

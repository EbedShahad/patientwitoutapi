...
import 'package:flutter_medical/screen/patient_profile/pages/homePatient_api.dart';
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    //  scale: 10.0,
                    fit: BoxFit.contain,
                    image: AssetImage("assets/images/secure_pass.png"),
                  ),
                ),
              ),
            ),
            Padding(
              ...
              child: Center(
                child: Text(
                  " Re set password",
                  style: TextStyle(color:mTitleTextColor, fontSize: 20),
                ),
              ),
            ),
            Padding(
